...
from market.market_data import OptionCalibrationPoint
...
class OptionsCSVLoader:
    ...
    def _row_to_calibration_point(
        ...
        maturity_date = self._expiration_to_datetime(row["expiration"])
    ...
    @staticmethod
    def _expiration_to_datetime(value: str) -> datetime | None:
        if not value:
            return None
        try:
